...
void main() {
  ...
  group('POST', () {
    ...
    test('Should call post with correct values with headers', () async {
      await sut.request(
          url: url,
          method: 'post',
          body: {'any_key': 'any_value'},
  ...
  group('GET', () {
    ...
    test('Should call get with correct values with headers', () async {
    ...
    test('Should return BadRequest if get returns 400 empty body', () async {
  ...
  group('PUT', () {
    ...
    test('Should call put with correct values with headers', () async {
      await sut.request(
          url: url,
          method: 'put',
          body: {'any_key': 'any_value'},
    ...
    test('Should return null if put returns 204 with no data', () async {
      mockResponse(204);
