...
import 'package:flutter_app/main/decorators/decorators.dart';
...
void main() {
  ...
  test('Should call decoratee with access token on header', () async {
    ...
    verify(httpClient.request(
        url: url, method: method, body: body, headers: {'x-access-token': token})).called(1);
    ...
    verify(httpClient.request(
        ...
        method: method,
        body: body,
        headers: {'x-access-token': token, 'any_header': 'any_value'})).called(1);
  });
