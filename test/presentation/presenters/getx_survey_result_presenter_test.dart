...
void main() {
  ...
  setUp(() {
    ...
    sut = GetxSurveyResultPresenter(
        loadSurveyResult: loadSurveyResult, saveSurveyResult: saveSurveyResult, surveyId: surveyId);
  ...
  group('loadData', () {
    ...
    test('Should emit correct events on success', () async {
      ...
      sut.surveyResultStream
          .listen(expectAsync1((result) => expect(result, mapToViewModel(loadResult))));
  ...
  group('save', () {
    ...
    test('Should emit correct events on success', () async {
      ...
      expectLater(sut.surveyResultStream,
          emitsInOrder([mapToViewModel(loadResult), mapToViewModel(saveResult)]));
